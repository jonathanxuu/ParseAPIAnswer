...
class WasmBridge {
  ...
  allocString(value) {
    return this.allocU8a((0, _util.stringToU8a)(value));
  }
  allocU64a(value) {
  ...
  resultString(retptr) {
    return (0, _util.u8aToString)(this.resultU8a(retptr));
  }
  resultU64a(retptr) {
    const r0 = this.getInt32()[retptr / 4 + 0];
    const r1 = this.getInt32()[retptr / 4 + 1];
  ...
  async initWasm(wasmBytes) {
    if (this.wasm) return;
    try {
      const source = await WebAssembly.instantiate((0, _util.hexToU8a)(wasmBytes));
