...
function scryptFromU8a(data) {
  ...
  const N = (0, _util.u8aToBn)(data.subarray(32 + 0, 32 + 4), BN_LE_OPTS).toNumber();
  const p = (0, _util.u8aToBn)(data.subarray(32 + 4, 32 + 8), BN_LE_OPTS).toNumber();
  const r = (0, _util.u8aToBn)(data.subarray(32 + 8, 32 + 12), BN_LE_OPTS).toNumber();
