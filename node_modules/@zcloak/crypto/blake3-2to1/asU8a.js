 ...
 * ```
 */
export function blake32to1AsU8a(data, bitLength = 256, key) {
  ...
  if (sliceCount === 1) {
    ...
    for (let i = 1; i < sliceCount; i++) {
      ...
      blake3Result = blake3(interHash, {
        dkLen: byteLength,
        key: key || undefined
      });
    }
  }
  return byteLength === 32 ? blake3Result : blake3(u8a, {
    dkLen: byteLength,
    key: key || undefined
  });
}
 ...
 */
export function blake32to1AsHex(data) {
