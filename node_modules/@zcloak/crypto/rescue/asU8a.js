...
import { rescuePrimeHash } from "../wasm/index.js";
 ...
 * ```
 */
export function rescuePrimeAsU8a(data, asU64a = false) {
 ...
 */
export function rescuePrimeAsHex(data, asU64a) {
  return u8aToHex(rescuePrimeAsU8a(data, asU64a));
}