...
import { rescuePrimeOptimizedHash } from "../wasm/index.js";
 ...
 * ```
 */
export function rescuePrimeOptimizedAsU8a(data, asU64a = false) {
 ...
 */
export function rescuePrimeOptimizedAsHex(data, asU64a) {
